...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_id = 3,                         /* id  */
  YYSYMBOL_op = 4,                         /* op  */
  YYSYMBOL_op_br = 5,                      /* op_br  */
  YYSYMBOL_cl_br = 6,                      /* cl_br  */
  YYSYMBOL_nw_ln = 7,                      /* nw_ln  */
  YYSYMBOL_quit = 8,                       /* quit  */
  YYSYMBOL_banner = 9,                     /* banner  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "id", "op", "op_br",
  "cl_br", "nw_ln", "quit", "banner", "$accept", "program", "S", "E", YY_NULLPTR
};
